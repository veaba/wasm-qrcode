...
// 各种主题风格
const wechat = generateWechatStyleQRCode('https://github.com/veaba/qrcodes');
const douyin = generateDouyinStyleQRCode('https://github.com/veaba/qrcodes');
const alipay = generateAlipayStyleQRCode('https://github.com/veaba/qrcodes');
const cyberpunk = generateCyberpunkStyleQRCode('https://github.com/veaba/qrcodes');
```

## 批量生成

```typescript
import { generateBatchQRCodes, QRErrorCorrectLevel } from '@veaba/qrcode-js';
