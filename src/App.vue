...
import {
  QRCode as QRCodeJS,
  generate_rounded_qrcode as jsRounded,
  generate_qrcode_with_logo_area as jsLogo,
  generate_gradient_qrcode as jsGradient,
  generate_wechat_style_qrcode as jsWechat,
  generate_douyin_style_qrcode as jsDouyin,
  generate_alipay_style_qrcode as jsAlipay,
  generate_xiaohongshu_style_qrcode as jsXiaohongshu,
  generate_cyberpunk_style_qrcode as jsCyberpunk,
  generate_retro_style_qrcode as jsRetro,
  generate_minimal_style_qrcode as jsMinimal,
} from '../qrcodejs/src/qrcode.js'
...
const generateJsQR = () => {
  try {
    ...
    jsModuleCount.value = qr.get_module_count()
    jsSvg.value = qr.get_svg()
  } catch (e) {
