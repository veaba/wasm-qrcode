...
# Shared 核心库测试
npx vitest run tests/qrcode-shared
```
...
- **测试内容**: 验证从 `qrcode-shared` 的 re-export 是否正确
...
import { QRCodeCore } from '../../packages/qrcode-shared/src/index.js';
