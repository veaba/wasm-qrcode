...
describe('@veaba/qrcode-ts - QRCode Class', () => {
...
describe('@veaba/qrcode-ts - Bun Specific Methods', () => {
...
describe('@veaba/qrcode-ts - Style Generator Functions', () => {
...
describe('@veaba/qrcode-ts - Batch Generation', () => {
...
describe('@veaba/qrcode-ts - Async Generation', () => {
...
describe('@veaba/qrcode-ts - Internal Classes', () => {
  // Note: QRMath is not exported from the module in qrcode-ts
...
describe('@veaba/qrcode-ts - Constants', () => {
...
describe('@veaba/qrcode-ts - Edge Cases', () => {
